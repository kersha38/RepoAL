...
LoginButton= tk.Button(ventaRegis, text="Iniciar Sesion", command=SGOA.runSGOA).place(x=150, y=300)
RegistraseButton= tk.Button(ventaRegis, text="Registrarse",command=runInforme).place(x=155,y=350)
ventaRegis.mainloop()
